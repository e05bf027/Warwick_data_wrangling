...
# ABG (from biochem)
ABG_biochem <- read_xlsx('/Users/davidhannon/Documents/02. Medicine/Med_Programming/MD_Metavision_wrangle/raw_data/01_AO/ABG_biochem/ABG_biochem_AO.xlsx')
...
# Make a list of tables to include in the workbook
data_sheets <- c(cardio_basic,
                 cardio_output,
                 ventilator_PB,
                 NIV_resp,
                 ABG_meta,
...
proning_output <- createWorkbook()
 
## Loop through the list of split tables as well as their names
##   and add each one as a sheet to the workbook
Map(function(data, name){
 
    addWorksheet(proning_output, name)
    writeData(data_sheets, name, data)
 
}, data_sheets, names(data_sheets))
 
 
## Save workbook to working directory
saveWorkbook(wb, file = "Patient_010.xlsx", overwrite = TRUE)
